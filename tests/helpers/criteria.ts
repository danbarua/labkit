...
import type { CheckStatus, EvaluationRecord, ResearchSession } from "@labkit/core-domain";
...
export async function evaluationsOf(
  ...
  return (await session.reads.criterionStanding({ criterion: check.criterion })).evaluations;
}
