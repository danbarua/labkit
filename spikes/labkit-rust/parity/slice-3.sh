...
# binary to regenerate `slice-3.expected`; run it against the Rust binary and
...
# landed.
#
# Usage:  slice-3.sh <command...>          e.g. slice-3.sh bun src/cli/cli.ts
#                                               slice-3.sh ./target/debug/labkit-grafeo
set -euo pipefail
