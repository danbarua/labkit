...
#
#   LK='bun packages/app-cli/cli.ts --db ~/Code/pycharm/bonsai-2026' scripts/db/probe-bonsai-1b2-1d.sh
#   LABKIT_DB_URL=... LK='bun packages/app-cli/cli.ts --tenant <slug>' scripts/db/probe-bonsai-1b2-1d.sh
#
...
LK="$LK --author probe-bonsai-1b2-1d.sh"
