...
#
#   LABKIT_HOME=~/Code/pycharm/bonsai-2026 bash scripts/db/probe-bonsai-1b2-1d.sh
#   bash scripts/db/probe-bonsai-1b2-1d.sh <db-dir>
#
...
lab() { bun "$root/packages/app-cli/cli.ts" --db "$db" --author probe-bonsai-1b2-1d.sh "$@"; }
