...
#
#   LABKIT_HOME=~/Code/pycharm/bonsai-2026 bash scripts/db/probe-bonsai-3-gates.sh
#   bash scripts/db/probe-bonsai-3-gates.sh <db-dir> [<bonsai-source-dir>]
#
...
exec bun "$root/scripts/db/import-bonsai-gates.ts" "$db" "$source_dir"
